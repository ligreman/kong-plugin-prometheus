...
local DEFAULT_BUCKETS = { 1, 2, 3, 5, 7, 10, 15, 20, 25, 30, 40, 50, 60, 70,
                          80, 90, 100, 200, 300, 400, 500, 750, 1000, 1500,
                          2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000,
                          12500, 15000, 17500, 20000, 25000, 30000, 35000, 40000,
                          50000, 60000 }
local metrics = {}
...
if pok then
  enterprise = require("kong.plugins.prometheus-custom.enterprise.exporter")
end
...
local function init()
  ...
  prometheus = require("kong.plugins.prometheus-custom.prometheus").init(shm, "kong_")
